                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Your School / Coaching Name</h4>
                                </div>
                            </div>
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center text-white"><small>Copyright © <a class="text-white" href="https://codecanyon.net/user/a-coder">a-coder | envato market place</a></small></p>
                    </div>
