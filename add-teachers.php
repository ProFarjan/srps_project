...
if(strlen($_SESSION['alogin'])==""){
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO  teachers(fullanme,teacher_id,designation,phone,email,password,gender,dob,status,reg_date) VALUES (:fullanme,:teacher_id,:designation,:phone,:email,:password,:gender,:dob,:status,:reg_date)";
...
<html lang="en">
    <head>
        ...
        <title>SRM Admin| Teacher Info< </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Add Teachers</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Student Teachers</li>
                                    </ul>
                                </div>
...
<div class="col-sm-10">
<input type="text" name="teacher_id" class="form-control" id="teacher_id" maxlength="5" required="required" autocomplete="off">
</div>
</div>
