    ...
    if (isset($_POST['submit'])) {
        ...
        foreach ($_POST['id'] as $count => $id) {
            ...
            for ($i = 0; $i <= $count; $i++) {
                ...
                $query->bindParam(':iid', $stid, PDO::PARAM_STR);
                $query->execute();
...
?>
    ...
    <head>
        ...
        <title>SMS Teacher| Student result info < </title>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" method="post">
                                                ...
                                                $ret = "SELECT tblstudents.StudentName,tblclasses.ClassName,tblclasses.Section from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblclasses on tblclasses.id=tblstudents.ClassId where tblresult.id=:stid limit 1";
